            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 sm:gap-y-0 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
              ...
              <div className=" px-6 py-16 lg:px-8">
                <div className="max-w-lg">
                  ...
                  <ol className="my-6 ml-2 list-decimal space-y-3 text-base md:ml-8 md:text-lg">
                    <li>
                      <span className="font-bold">The Farmhouse Well</span>
                      <ul className="ml-2 list-roman text-gray-600">
                        <li>
                  ...
                  <ul className="ml-2 list-decimal text-base text-gray-600 md:ml-8 md:text-lg">
                    <li>
